%==============================================
% WorldTheory.pl for actor mbotagent
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumbotagent).	%%old version (deprecated)
actorobj(qatumbotagent).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mbotagent
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mbotagent" ). 
...
%-------------------------------------------------
%  User static rules about mbotagent
%------------------------------------------------- 
/*
------------------------------------------------------------------------
