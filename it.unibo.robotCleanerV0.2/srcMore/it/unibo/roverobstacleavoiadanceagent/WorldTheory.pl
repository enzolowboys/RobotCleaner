%==============================================
% WorldTheory.pl for actor roverobstacleavoiadanceagent
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturoverobstacleavoiadanceagent).	%%old version (deprecated)
actorobj(qaturoverobstacleavoiadanceagent).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor roverobstacleavoiadanceagent
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of roverobstacleavoiadanceagent" ). 
...
%-------------------------------------------------
%  User static rules about roverobstacleavoiadanceagent
%------------------------------------------------- 
/*
------------------------------------------------------------------------
