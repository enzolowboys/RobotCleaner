%==============================================
% WorldTheory.pl for actor mbotcleanercontroller
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumbotcleanercontroller).	%%old version (deprecated)
actorobj(qatumbotcleanercontroller).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mbotcleanercontroller
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mbotcleanercontroller" ). 
...
%-------------------------------------------------
%  User static rules about mbotcleanercontroller
%------------------------------------------------- 
eval( ge,X,X).
