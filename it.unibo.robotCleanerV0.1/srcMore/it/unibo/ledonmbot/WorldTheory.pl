%==============================================
% WorldTheory.pl for actor ledonmbot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledonmbot).	%%old version (deprecated)
actorobj(qatuledonmbot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledonmbot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledonmbot" ). 
...
%-------------------------------------------------
%  User static rules about ledonmbot
%------------------------------------------------- 
/*
------------------------------------------------------------------------
