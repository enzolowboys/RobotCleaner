%==============================================
% WorldTheory.pl for actor mbotcleaner
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumbotcleaner).	%%old version (deprecated)
actorobj(qatumbotcleaner).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mbotcleaner
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mbotcleaner" ). 
...
%-------------------------------------------------
%  User static rules about mbotcleaner
%------------------------------------------------- 
eval( ge,X,X).
