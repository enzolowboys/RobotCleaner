%==============================================
% WorldTheory.pl for actor sendtemperaturecontroller
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusendtemperaturecontroller).	%%old version (deprecated)
actorobj(qatusendtemperaturecontroller).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sendtemperaturecontroller
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sendtemperaturecontroller" ). 
...
%-------------------------------------------------
%  User static rules about sendtemperaturecontroller
%------------------------------------------------- 
eval( ge,X,X).
